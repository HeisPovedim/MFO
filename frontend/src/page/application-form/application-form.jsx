...
import PersonHeaderPng from '../../img/basic-page-img/person-header.png'
        ...
        <nav className="nav" style={{display: "flex"}}>
          ...
          <div id="menu" className="faqs-container collapse navbar-collapse">
            <div className="faq" style={{borderTop: "1px solid #9fa4a8"}}>
              <a href="o-nas.html" className="faq-title">
              О нас
              </a>
              <a href="novosti.html" className="faq-text">
              Новости
              </a>
              <a href="dokumenty.html" className="faq-text">
              Документы
              </a>
              <a href="kontakty.html" className="faq-text">
              Контакты
              </a>
            ...
            <div className="faq">
              <a href="kak-oformit-zajm.html" className="faq-title">
              Как оформить займ
              </a>
              <a href="legal-assistance.html" className="faq-text">
              Дополнительные услуги
              </a>
              <a href="kak-otsrochit-vyplatu.html" className="faq-text">
            ...
            <div className="faq">
              <a href="kak-poluchit-dengi.html" className="faq-title">
              Как получить деньги
              </a>
              <a href="na-bankovskuyu-kartu.html" className="faq-text">
              На банковскую карту
              </a>
              <button className="faq-toggle">
              <i className="fa fa-chevron-down"></i>
            ...
            <div className="faq">
              <a href="kak-pogasit-zaem.html" className="faq-title">
              Как погасить
              </a>
              <a href="bankovskaya-karta.html" className="faq-text">
              Банковская карта
              </a>
              <a href="bankovskij-perevod.html" className="faq-text">
              Банковский перевод
              </a>
              <button className="faq-toggle">
              <i className="fa fa-chevron-down"></i>
            ...
            <div className="faq">
              <a href="faq.html" className="faq-title">
              Вопросы/Ответы
              </a>
            </div>
            <div className="faq">
              <a href="vashi-prava-klienta-narusheny.html" className="faq-title">
              Пожаловаться
              </a>
            </div>
          </div>
            ...
            <div className="right-block">
              ...
              <div className="mr_content-box frst_stp" data-step_id="kontaktnaya_informaciya" data-step_index="1">
                  ...
                  <div className="wrapper-master">
                    <div className="wrapper-inputs frst_stp">
                      ...
                      <div className="input-box inpBxFF" id="form_email">
                        ...
                        <input id="email" className="input_field search_in_session" type="email" maxLength="100" data-required="true" name="kontaktnaya_informaciya[email]" data-index_group="" placeholder="" defaultValue="" />
                        <div id="error_email" className="help-block hidden">Необходимо заполнить поле &quot;Email адрес&quot;</div>
                      </div>
                ...
                <div className="gosuslugi_box">
                  <a href="javascript:void(0)" id="authByEsia" className="link_authByEsia" onClick="window.top.location.href='https://zab.p.rnds.pro/oauth/authorizations/new?response_type=code&amp;scope=openid%20profile%20fullname%20id_doc&amp;client_id=048199b6276a91b8c0a9012a746234d8&amp;redirect_uri=https://zabiray.ru/esia'">Войти через Госуслуги</a>
                </div>
              </div>
