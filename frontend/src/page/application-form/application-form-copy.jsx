                  ...
                  <div className="wrapper-master">
                    <div className="wrapper-inputs frst_stp">
                      ...
                      <div className="input-box inpBxFF" id="form_first_name">
                        ...
                        <input id="first_name" className="input_field rus" type="text" placeholder="Имя" value={firstName}
                          {...register('firstName', {
                            required: true,
                            minLength: {
                              value: 2,
                      ...
                      <div className="input-box inpBxFF" id="form_middle_name">
                        ...
                        <input id="middle_name" className="input_field rus" type="text" placeholder="Отчество" value={middleName} 
                          {...register('middleName', {
                            required: false,
                            minLength: {
                              value: 2,
